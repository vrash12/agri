...
- The new saved-appearance feature starts these 93 Region II references with white fill at 20% opacity. Applied and verified locally; Hostinger deployment is pending. The setup preserves boundary shapes, other provinces' colors and all account assignments. See `docs/GEOFENCE_APPEARANCE_2026_09_21.md`.

...
<div class="ops-dashboard">
  <header class="ops-header">
    ...
    <div class="ops-actions" aria-label="Quick actions">
      <a class="ops-button ops-button-secondary" href="{{ route('farmers.index', ['show_weather' => 1]) }}#farmersMapModule">
  ...
  <section class="ops-kpi-grid" aria-label="Key performance indicators">
    ...
    <article class="ops-kpi">
      <div class="ops-kpi-top">
        <span class="ops-kpi-label">Machinery assets</span>
        <span class="ops-icon ops-icon-green">
      ...
      <strong class="ops-kpi-value">{{ number_format((int) ($stats['total_machineries'] ?? 0)) }}</strong>
      <div class="ops-kpi-foot">
        <span>{{ number_format((int) ($stats['available_machineries'] ?? 0)) }} available · {{ number_format((int) ($stats['machineries_needing_attention'] ?? 0)) }} need attention</span>
        <a href="{{ route('machinery-inventory.index') }}">Open inventory</a>
      </div>
    </article>
  </section>
  ...
  <div class="ops-layout">
    ...
    <aside class="ops-side-column">
      <section class="ops-panel">
        <div class="ops-panel-header ops-panel-header-compact"><div><span class="ops-panel-kicker">Operational readiness</span><h2>Attention needed</h2></div></div>

    ...
    <div class="module-more-content">
      <form class="backup-upload-form" method="POST" action="{{ route('backups.store') }}" enctype="multipart/form-data">
        ...
        <div class="backup-upload-fields">
          ...
          @endif
          <div class="module-form-field"><label for="backup_folder">Folder</label><input class="module-input" id="backup_folder" name="folder" value="{{ old('folder') }}" placeholder="e.g. audits/2026"><div class="module-hint">Blank uses {{ \App\Support\LocalTime::now()->format('Y/m') }} automatically.</div></div>

...
@push('styles')
  ...
  <style>
    .audit-detail-hero{background:var(--ui-surface)}
    ...
    .audit-summary{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:0;padding:4px 16px 16px}.audit-summary div{min-width:0;padding:13px 12px;border-right:1px solid #e8ede9;border-bottom:1px solid #e8ede9}.audit-summary div:nth-child(3n){border-right:0}.audit-summary dt{color:var(--module-muted);font-size:12px;font-weight:700;letter-spacing:.05em;text-transform:none}.audit-summary dd{margin:5px 0 0;overflow-wrap:anywhere;color:var(--module-ink);font-size:12px;font-weight:700;line-height:1.45}.audit-summary dd.module-mono{font-size:12px}
    .audit-change-table{width:100%;border-collapse:collapse}.audit-change-table th{padding:10px 13px;color:var(--module-muted);background:#f8faf8;border-bottom:1px solid var(--module-border);font-size:12px;font-weight:700;letter-spacing:.05em;text-align:left;text-transform:none}.audit-change-table td{width:40%;padding:12px 13px;border-bottom:1px solid #edf1ee;color:#45534a;font-size:12px;line-height:1.5;vertical-align:top;overflow-wrap:anywhere}.audit-change-table td:first-child{width:20%;color:var(--module-ink);font-weight:700}.audit-change-table tr:last-child td{border-bottom:0}.audit-value{display:block;max-height:170px;overflow:auto;white-space:pre-wrap}.audit-value-old{color:#8d4242}.audit-value-new{color:#17643a}.audit-empty-value{color:#8a958e;font-style:italic}
    .audit-context{padding:4px 16px 16px}.audit-context-row{padding:11px 0;border-bottom:1px solid #edf1ee}.audit-context-row:last-child{border-bottom:0}.audit-context-row span{display:block;color:var(--module-muted);font-size:12px;font-weight:700;letter-spacing:.045em;text-transform:none}.audit-context-row strong,.audit-context-row code{display:block;margin-top:5px;overflow-wrap:anywhere;color:var(--module-ink);font-size:12px;line-height:1.5}.audit-context-row code{padding:9px;border-radius:7px;background:#f6f8f6;white-space:pre-wrap}
    .audit-lock-note{display:flex;gap:9px;padding:13px;border:1px solid #dce5df;border-radius:9px;color:#57645c;background:#f8faf8;font-size:12px;line-height:1.5}.audit-lock-note svg{width:18px;height:18px;flex:0 0 auto;color:var(--module-green);fill:none;stroke:currentColor;stroke-width:1.8}
    ...
    @media(max-width:650px){.audit-summary{grid-template-columns:1fr}.audit-summary div,.audit-summary div:nth-child(3n){border-right:0}.audit-change-table thead{display:none}.audit-change-table,.audit-change-table tbody,.audit-change-table tr,.audit-change-table td{display:block;width:100%}.audit-change-table tr{padding:11px 13px;border-bottom:1px solid #e6ece8}.audit-change-table td{padding:4px 0;border:0}.audit-change-table td:first-child{width:100%;margin-bottom:5px}.audit-change-table td:nth-child(2):before{content:'Before';display:block;color:var(--module-muted);font-size:12px;font-weight:700;text-transform:none}.audit-change-table td:nth-child(3):before{content:'After';display:block;margin-top:6px;color:var(--module-muted);font-size:12px;font-weight:700;text-transform:none}}
    .audit-summary dd,.audit-change-table td,.audit-context-row strong,.audit-context-row code,.audit-lock-note{font-size:14px}.audit-summary dt,.audit-change-table th,.audit-context-row span{font-weight:500}
  </style>
@endpush
...
<div class="module-page">
  ...
  <div class="audit-detail-grid">
    <div class="audit-stack">
      <section class="module-panel">
        ...
        <dl class="audit-summary">
          ...
          <div><dt>Municipality</dt><dd>{{ $auditLog->municipality?->name ?? ($auditLog->province?->name ?: 'System-wide / unassigned') }}</dd></div>
    ...
    <aside class="audit-stack">
      <details class="module-more"><summary>Request context and metadata</summary>

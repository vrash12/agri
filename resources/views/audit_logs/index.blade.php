...
@php
  ...
  $eventOrder = ['login_failed', 'login_blocked', 'login_throttled', 'login_failures_suppressed', 'session_timeout', 'deleted', 'updated', 'created', 'login', 'logout', 'membership_updated', 'exported'];

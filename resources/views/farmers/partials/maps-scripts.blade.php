  ...
  async function initFarmersMap3D() {
    ...
    function refreshAllMarkerPins() {
      markersById.forEach(function (marker, id) {
        ...
        applyMarkerPin(marker, farmer, String(id) === String(selectedFarmerId || ''));
      });
    }
    ...
    function renderPlotsForFarmer(farmerId, plots) {
      ...
      if (!plots || !plots.length || !Polygon3DElement) return;
...
window.onload = function () {
  var img = document.getElementById("plotStaticMap");
...
<\/script>
    ...
    function printPlotSheet(farmer, plot) {
      ...
      var w = window.open('', '_blank', 'width=1400,height=980');

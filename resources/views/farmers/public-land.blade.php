...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .brand{display:flex;align-items:center;min-width:0;gap:12px}.brand img{width:48px;height:48px;padding:4px;object-fit:contain;border:1px solid var(--line);border-radius:14px;background:#fff}.brand strong,.brand span{display:block}.brand strong{font-size:14px}.brand span{margin-top:3px;color:var(--muted);font-size:12px}
    .verified{display:flex;align-items:center;gap:8px;padding:8px 11px;border-radius:999px;color:#0a6534;background:#e6f6eb;font-size:12px;font-weight:700;letter-spacing:.05em;text-transform:none}.verified i{display:grid;place-items:center;width:18px;height:18px;border-radius:50%;color:#fff;background:#16a05a;font-style:normal}
    ...
    .eyebrow{display:flex;align-items:center;gap:8px;color:var(--green);font-size:12px;font-weight:700;letter-spacing:.11em;text-transform:none}.eyebrow:before{content:"";width:22px;height:3px;border-radius:999px;background:var(--gold)}
    ...
    .hero-stats{position:relative;z-index:1;display:flex;flex-wrap:wrap;gap:8px;margin-top:22px}.hero-stat{min-width:126px;padding:10px 12px;border:1px solid #dce9df;border-radius:12px;background:#f8fbf8}.hero-stat span,.hero-stat strong{display:block}.hero-stat span{color:var(--muted);font-size:12px;font-weight:700;letter-spacing:.08em;text-transform:none}.hero-stat strong{margin-top:5px;font-size:16px}
    .registry-card{display:flex;flex-direction:column;padding:18px}.registry-card-top{display:flex;align-items:center;gap:12px}.registry-mark{display:grid;place-items:center;width:48px;height:48px;flex:0 0 auto;border-radius:15px;color:#fff;background:linear-gradient(135deg,var(--green-2),var(--green));font-size:16px;font-weight:700}.registry-card h2{margin:0;font-size:16px}.registry-id{margin-top:4px;color:var(--green);font:800 11px ui-monospace,monospace}.registry-lines{display:grid;gap:12px;margin-top:18px}.registry-line{padding-top:11px;border-top:1px solid #e5ece7}.registry-line span,.registry-line strong{display:block}.registry-line span{color:var(--muted);font-size:12px;font-weight:700;letter-spacing:.07em;text-transform:none}.registry-line strong{margin-top:4px;font-size:12px}.privacy-note{margin-top:auto;padding:11px;border-radius:11px;color:#53645a;background:var(--soft);font-size:12px;line-height:1.5}
    ...
    .parcel-panel{display:flex;min-height:0;flex-direction:column;border-right:1px solid var(--line);background:#fbfdfb}.panel-head{padding:19px 18px 15px;border-bottom:1px solid var(--line)}.panel-head small,.panel-head strong{display:block}.panel-head small{color:var(--green);font-size:12px;font-weight:700;letter-spacing:.1em;text-transform:none}.panel-head strong{margin-top:5px;font-size:18px}.panel-head p{margin:5px 0 0;color:var(--muted);font-size:12px;line-height:1.45}
    .parcel-list{display:grid;align-content:start;gap:8px;min-height:0;padding:12px;overflow:auto}.parcel-button{width:100%;display:grid;grid-template-columns:36px 1fr auto;align-items:center;gap:10px;padding:10px;border:1px solid var(--line);border-radius:12px;color:var(--ink);background:#fff;text-align:left;cursor:pointer;transition:.15s ease}.parcel-button:hover,.parcel-button:focus-visible,.parcel-button.is-active{border-color:#7eb692;background:#eef8f1;outline:none;box-shadow:0 7px 18px rgba(18,92,50,.09);transform:translateY(-1px)}.parcel-swatch{display:grid;place-items:center;width:36px;height:36px;border-radius:11px;color:#fff;background:var(--plot-color);font-size:12px;font-weight:700}.parcel-copy{min-width:0}.parcel-copy strong,.parcel-copy span{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.parcel-copy strong{font-size:12px}.parcel-copy span{margin-top:3px;color:var(--muted);font-size:12px}.parcel-arrow{color:#799085;font-size:20px}
    .empty-parcels{margin:10px;padding:20px 13px;border:1px dashed #c8d9ce;border-radius:13px;text-align:center;background:#fff}.empty-parcels strong,.empty-parcels span{display:block}.empty-parcels strong{font-size:12px}.empty-parcels span{margin-top:6px;color:var(--muted);font-size:12px;line-height:1.5}
    .map-card{position:relative;min-height:620px;background:#e9eee9}.map-toolbar{position:absolute;z-index:500;top:13px;left:50%;display:flex;gap:7px;transform:translateX(-50%)}.map-action{display:flex;align-items:center;gap:6px;min-height:36px;padding:0 11px;border:1px solid rgba(24,65,39,.16);border-radius:10px;color:#173e27;background:rgba(255,255,255,.96);box-shadow:0 7px 20px rgba(4,24,11,.13);font-size:12px;font-weight:700;cursor:pointer}.map-action:hover{background:#f0f8f2}.map-action svg{width:14px;height:14px;fill:none;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}
    #landMap{width:100%;height:620px}.gm-style{font-family:Roboto,system-ui,sans-serif}.map-popup strong,.map-popup span{display:block}.map-popup strong{font-size:12px}.map-popup span{margin-top:4px;color:#66766c;font-size:12px}.map-legend{position:absolute;z-index:5;right:12px;bottom:22px;max-width:210px;padding:9px 11px;border:1px solid rgba(24,65,39,.13);border-radius:11px;background:rgba(255,255,255,.95);box-shadow:0 7px 20px rgba(4,24,11,.12);font-size:12px;pointer-events:none}.map-legend strong{display:block}.map-legend span{display:block;margin-top:3px;color:var(--muted);line-height:1.35}.map-error{position:absolute;z-index:600;inset:50% auto auto 50%;display:none;width:min(380px,calc(100% - 30px));padding:18px;transform:translate(-50%,-50%);border:1px solid #e5c8a1;border-radius:14px;background:#fffaf2;text-align:center;box-shadow:0 14px 35px rgba(69,45,14,.15)}.map-error strong,.map-error span{display:block}.map-error span{margin-top:6px;color:#755f43;font-size:12px;line-height:1.45}
    .footer{display:flex;justify-content:space-between;gap:15px;padding:17px 3px 0;color:#718078;font-size:12px}.footer strong{color:#385443}
    ...
    @media(max-width:560px){.shell{padding:10px 10px 25px}.masthead{padding:10px 11px;border-radius:14px}.brand img{width:40px;height:40px}.brand strong{font-size:12px}.brand span{font-size:12px}.verified{padding:7px;font-size:0}.verified i{font-size:12px}.hero-main,.registry-card,.workspace{border-radius:15px}.hero-main{padding:22px 18px}.hero-stats{display:grid;grid-template-columns:repeat(2,minmax(0,1fr))}.hero-stat{min-width:0}.parcel-list{grid-template-columns:1fr;max-height:210px}.map-toolbar{top:10px;left:10px;right:10px;justify-content:center;transform:none}.map-action{padding:0 9px}.map-action span{display:none}.map-legend{right:9px;bottom:18px}.footer{flex-direction:column}}
      :root{--ink:var(--ui-text);--muted:var(--ui-text-muted);--green:var(--ui-primary);--green-2:var(--ui-primary-hover);--gold:var(--ui-accent);--soft:var(--ui-primary-soft);--line:var(--ui-border);--shadow:none}
    body{background:var(--ui-page-background);font-size:14px;line-height:1.5}
    .topline{background:var(--ui-brand-stripe)}
    .masthead,.hero-main,.registry-card,.workspace{border-radius:12px;box-shadow:none}
    .masthead{background:var(--ui-surface);backdrop-filter:none}
    .hero-main:after,.eyebrow:before{display:none}
    .map-action{min-height:44px;font-size:14px;font-weight:500;border-radius:8px}
    .parcel-button{min-height:44px}
    .parcel-button:focus-visible,.map-action:focus-visible{outline:3px solid var(--ui-focus);outline-offset:3px}
...
<body>
  ...
  @else
    <script>
      ...
      document.getElementById('mapErrorMessage').textContent = 'The map is temporarily unavailable. Contact the agriculture office if you need help viewing these parcels.';
    </script>
  @endif
</body>
</html>

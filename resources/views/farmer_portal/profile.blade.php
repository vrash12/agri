...
<section class="fp-guidance"><h2>Keep your account private</h2><p>Your login ID is <strong class="fp-break">{{ $account->login_id }}</strong>. Sign out after using a shared phone or computer. Contact your agriculture office if you need account recovery.</p></section>
@endsection

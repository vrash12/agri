...
<section class="fp-overview" aria-labelledby="overview-title"><div><h2 id="overview-title">My agriculture records</h2><p>View your information and keep track of recorded assistance.</p><span class="fp-registry">{{ $farmer->agri_gov_id }}</span></div><a class="module-button" href="{{ route('farmer-portal.profile') }}">View my profile</a></section>

...
After installation, check owner, regional, provincial and municipal workspace flows, direct municipality links, reporting years, both served asset copies, and public HTTP health. Complete actual production verification before calling this release deployed.

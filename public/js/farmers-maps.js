/*
 * Farmer plotting workspace.
 *
 * Extracted from resources/views/farmers/partials/maps-scripts.blade.php so this is
 * a real JavaScript file: editors and linters can read it, it is diffable, and the
 * template compiler can no longer swallow part of it.
 *
 * It was two sequential <script> blocks, the Maps API bootstrap and the workspace
 * itself, and they are concatenated here in the same order. It stays a classic
 * script rather than an ES module so the var declarations shared between those two
 * blocks, and the window.__* functions this file exports to the rest of the page,
 * keep behaving exactly as before.
 *
 * Everything the server decides arrives on window.__* from the config block in
 * resources/views/farmers/maps.blade.php. There are no server values in this file.
 */
...
var PRINT_LEFT_LOGO  = window.__printLeftLogo || '/images/mao-logo.jpg';
var PRINT_RIGHT_LOGO = window.__printRightLogo || '/images/ramos-logo.jpg';

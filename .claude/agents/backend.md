...
- Form Request classes for new forms with complex or reusable validation; concise controller validation is acceptable for small one-purpose endpoints that match the surrounding module.
